...
프론트엔드 웹개발을 배우면서 드러났던 문제점을 분석한 글입니다.
...
### 해결방법
목적을 항상 서두에 말한 뒤 써놓고 그것을 보면서 말하는 연습을 해야겠다.
...
과거를 회상하자면, 나는 내부적으로 자신감이 부족한 사람은 맞았다. 하지만 겉으로 보이는 데에 있어서는 자신감 있는 태도를 연기했었다. 자신감이 없다는 피드백을 받은 적이 없었기 때문이다.

그런데 과거 경험으로 인해 자신감이 없어졌다는 결론을 내릴 수 있다.

하지만 성장하려면 과거, 환경 탓만 할 수 없다. 

그럼에도 불구하고 이유를 찾고 동기부여를 해야 성장할 수 있다.

과거에 어떠한 경험을 했던지간에, 지금 내가 당면하고 있는 문제는 "자신감이 없다"는 것이다. 현재 가지고 있는 문제에 집중하자. 

과거의 기억을 완전히 청산하는 방법 따위는 물리적으로 존재하지 않기 때문이다.

### 해결방법

1. 하루 5분 명상하기

2. 일주일에 2번 가는 운동을 계속하기
